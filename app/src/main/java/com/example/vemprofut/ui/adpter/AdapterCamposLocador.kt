...
class AdapterCamposLocador(
    private val camposCadastradosLocador : ArrayList<Campo>,
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdapterCamposLocador.MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.card_campo, parent, false)

        return MyViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: AdapterCamposLocador.MyViewHolder, position: Int) {
        val campo = camposCadastradosLocador[position]
    ...
    override fun getItemCount() = camposCadastradosLocador.size
}